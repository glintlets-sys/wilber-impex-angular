...
export class CartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.authService.isUserLoggedIn.subscribe((val => {
      ...
      this.loadingService.showLoadingOverlay("Loading your cart items ... ", 3000);
      this.updateCart();
    }));
  ...
  getCouponCodeApplied() {
    return this.couponApplicationResponse==null?false:this.couponApplicationResponse.success;
  }
  ...
  getCouponDiscountAmount() {
    return this.couponApplicationResponse==null?0:this.couponApplicationResponse.discountAmount;
  }
        ...
        if (JSON.stringify(cartNew) !== JSON.stringify(oldCart)) {
          ...
          this.paymentService.initiatePayment().subscribe(
            (response) => {
              ...
              console.log("Order id: " + this.orderId);
              // Now that the order details are stored. Initiate the payment. 
              this.toaster.showToast("Redirecting to Payment gateway", ToastType.Info, 3000);
